...
message.textContent = 'We use cookies for improved funcionality and analitycs.';
message.innerHTML =
  'We use cookies for improved funcionality and analitycs. <button class="btn btn--close--cookie">Got it!</button>';
...
//deleting elemetns
document.querySelector('.btn--close--cokie');
...
document.documentElement.style.setProperty('--coolor-primary', 'orangered');
